...
export default function Sidebar() {
    return (
        <aside
            className="w-64 fixed top-0 left-0 sm:relative md:h-full flex-col justify-between hidden sm:flex"
            aria-label="Sidebar"
        >
            <div className="overflow-y-auto py-4 px-3 bg-white h-screen dark:bg-gray-800">
